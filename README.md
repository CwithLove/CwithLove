...
Personal cybersecurity lab in progress, focused on log monitoring and incident detection.

Current scope:

- Wazuh environment with Ubuntu Server and Linux endpoint
- Log collection and analysis
- SSH failed login detection scenario
...
University project evaluated 18/20.

Implementation of a Unix command interpreter in C with:
...
University project evaluated 19/20.

Implementation of an ARMv5 emulator in C with:
...
![Unix](https://img.shields.io/badge/Unix-111827?style=for-the-badge)
